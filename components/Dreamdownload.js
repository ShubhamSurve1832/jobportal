      ...
      <div className='enq-form'>
        <div className='form-header'>
          ...
          }
          {
            ...
            showHeading2 ? <p>Download Prospectus</p> : " "
          }
        </div>
        <div className='form-box'>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className='input-box'>
              ...
              {success && (hideBtn ? " " : <a href="https://simandhareducation-files.s3.ap-south-1.amazonaws.com/img/Final-Deck-ppt-Dream+to+work+in+the+US+(1)-Watermark.pdf" target="_blank" download={true} className='btn maroon-btn maroon-btn-arrow dwn-btn' onClick={hideDwnBtn}>Download PDF</a>)}
