        ...
        <div className='form-box'>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className='input-box'>
              ...
              {success && (hideBtn ? " " : <a href="https://www.becker.com/cma-review/course-demo" target="_blank" download={true} className='btn maroon-btn maroon-btn-arrow dwn-btn' onClick={hideDwnBtn}>Free Link</a>)}
