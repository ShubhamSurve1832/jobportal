...
const DownloadFormComponents = ({ showHeading, setCourse, showHeading2, indexData, formName, DownloadForm, Qualification, heading3 }) => {
  ...
  return (
    <>
      <div className='enq-form' style={{textAlign:"left !important"}}>
        <div className='form-header'>
          ...
          {
            showHeading2 ? <p>Submit Your Details</p> : " "
          }
        </div>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            {/* <div className='input-box custom-select'>
              ...
              >
                ...
                <option value='Data Analytics'>FNF</option>
              </select>
              {errors.course && <span className='error-message'>{errors.course?.message}</span>}
            </div> */}
            ...
            <div className='input-box'>
              ...
              {success && (hideBtn ? " " : <a href="https://www.youtube.com/watch?v=-0szUwKHRno" target="_blank" download={true} className='btn maroon-btn maroon-btn-arrow dwn-btn' onClick={hideDwnBtn}>Watch Demo Video</a>)}
