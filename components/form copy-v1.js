...
const FormComponents = ({ isactive, showPopup, formName,Qualification }) => {
  ...
  // console.log(values)
  const { name, email, utmSource, number, utm_medium, utm_campaign, course, MainSource ,degree} = values;
        ...
        <div className='form-box'>
          ...
          <form method="post" onSubmit={handleSubmit(onFormSubmit)}>
...

            {
                        Qualification ?
                            <div className='input-box'>
                                <input type="text" name="degree " placeholder='degree' minLength="2"
                                    value={degree}
                                    {...register("degree", {
                                    ...
                                    className={errors.degree ? 'error-border' : null}
