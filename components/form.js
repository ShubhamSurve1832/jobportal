...
const FormComponents = ({ isactive, showPopup, formName }) => {
  ...
  // console.log(values)
  const { name, email, utmSource, number, utm_medium, utm_campaign, course, MainSource,qualification } = values;
...
{/* 
            ...
            <div className='input-box custom-select'>
              <select id="select-qualification" name="qualification" placeholder='Select qualification'
                {...register("qualification",
                  {
              ...
              >
                ...
                <option value='CA-inter/final'>CA Inter/Final</option>
                <option value='CFA'>CFA</option>
                <option value='CIA'>CIA</option>
                <option value='CLASS-X'>CLASS X</option>
                <option value='CLASS-XII'>CLASS XII</option>
                <option value='CMA'>CMA</option>
                <option value='CMA-inter/final'>CMA Inter/Final</option>
                <option value='CPA'>CPA</option>
                <option value='CS'>CS</option>
                <option value='CS-inter/final'>CS Inter/Final</option>
