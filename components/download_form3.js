    ...
    <>
      <div className='enq-form'>
        <div className='form-header'>
          ...
          {
            showHeading2 ? <p>Free Becker 15 Days Trial</p> : " "
          }
        </div>
        <div className='form-box'>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className='input-box'>
              ...
              {success && (hideBtn ? " " : <a href="https://www.becker.com/cpa-review/course-demos" target="_blank" download={true} className='btn maroon-btn maroon-btn-arrow dwn-btn' onClick={hideDwnBtn}>Free Link</a>)}
