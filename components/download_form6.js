        ...
        <div className='form-box'>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className='input-box'>
              ...
              {success && (hideBtn ? " " : <a href="https://www.becker.com/cpa-review/course-demos" target="new" download={true} className='btn maroon-btn maroon-btn-arrow dwn-btn' onClick={hideDwnBtn}>Enrol Now</a>)}
