...
const CommonFormPop = ({ isactive, showPopup, showTitle, showcity, showcourse,setCourse, indexData, formName, showDownloadMCQ, showCtc, position, showRadio, showRadioStatus, showPara, shownoticeperiod, showposition, showLastCompany, showResume, showIcon, Qualification }) => {
            ...
            <div className='form-box'>
                <div className="form-header">
                    ...
                    }
                    {
                        showTitle ? (
                            <>
                                <h6 className='heading06'>Register Now</h6>
                                <p>{position}</p>
                            </>
                        ) : ('')
                    }
                ...
                <form onSubmit={handleSubmit(onFormSubmit)}>
                        ...
                        showcourse ?
                            <div className='input-box custom-select'>
                                ...
                                >
                                    ...
                                    <option value='Samarth'>Simandhar Saamarth</option>
                                </select>
                    ...
                    <div className='input-box'>
                        <button type="submit" className={`btn maroon-border-btn maroon-border-btn-arrow ${isButtonDisabled ? 'disabled' : ''}`}> Register</button>
