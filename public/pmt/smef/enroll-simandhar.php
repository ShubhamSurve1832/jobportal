...
<html>
	<head>
		...
		<script src="https://simandhareducation.com/students-v6.js?v=12"></script>
	...
	<link rel="shortcut icon" href="https://res.cloudinary.com/dppqknkpc/image/upload/v1635519231/Simandhar_New_Logo_3_afjpvv.png" type="image/x-icon">
		...
		<style>
			.per_info .info_dtl .personal_info input, .per_info .info_dtl .personal_info select, .per_info .info_dtl .personal_info textarea{
				width:100% !important;
			}
			.p-top{
				padding-top:1.25em;
			...
			.cardType{
				...
				color: #9b9b9b;
				font: 400 13px/150% 'Rubik', sans-serif;
				border-radius: 1px;
			...
			.per_info .info_dtl .personal_info input { color: #333!important } 
		</style>
			...
			function calculate(){
				...
				var card_type = $('#card_type').find(':selected').data('card_val');

				if(card_type ==1 && parseInt(actualAmount)>2000){
					amount =  parseFloat(actualAmount)+parseFloat(23.60);
					amount = amount.toFixed(2);
				}
				else if(card_type ==1){
					total_int =  parseFloat(($('#card_type').val()/100)*actualAmount);
					total_amt_gst = parseFloat((18/100)*total_int)+parseFloat(total_int);
					amount = parseFloat(total_amt_gst)+ parseFloat(actualAmount);
					amount=amount.toFixed(2);
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="thank-you-pop">
							<img src="https://goactionstations.co.uk/wp-content/uploads/2017/03/Green-Round-Tick.png" alt="">
							<h1>Thank You!</h1>
									...
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="heading8122873">
											<h5 class="panel-title" >
												<a role="button" data-toggle="collapse" class="accordion-plus-toggle collapsed" data-parent="#accordion7401210" href="#collapse8122873" aria-expanded="false" aria-controls="collapse8122873">RazorPay</a>  <span> </span>
											</h5>
										</div>
										...
										<!-- code changes by Venu for testing -->
...
">Note: Please don't fill the Email ID already used in Becker demo. Mention accurate and complete address for timely book shipping*</div>
										...
										<div class="col-md-6">
											<select name="c_name" id="cname" class="pay_city" required>
                                                ...
                                                <option value="Vishal">Vishal T </option>
                                                <option value="Vishal-Pariwal ">Vishal Pariwal  </option>
                                                <option value="Others">Others</option>
        ...
        $("#profession").change(function () {
            if ($(this).val() == "professional") {
                ...
                $("#student-professional").hide();
										...
										<input type="hidden"  name="redirect_url" value="https://www.simandhareducation.com/ccavResponseHandler.php"/>
										<input type="hidden" name="cancel_url" value="https://www.simandhareducation.com/ccavResponseHandler.php"/><input type="hidden" name="language" value="EN"/>
...
-->
						...
						<div class="pay_faqs_container desktop_pay_faqs" style="display:;">
							...
							<div class="pay_faqs">
								...
								<p>You can contact our customer service team at <a href="tel:+91-8977633523">+91-8977633523</a>
   ...
   <i class="pay_chat_icon"></i>
								...
								<div class="panel pay_other_option" style="display:none;">
									...
									<div id="collapse2" class="collapse in">
										<div class="pay_options text-center" style="margin:0px !important;">
											<button class="btn btn-lg btn-block btn-primary " style="margin:5px auto;"><a style="color:white;" href="https://m.p-y.tm/simandhar_web" >Click Here to Pay</a></button>
				...
				<div class="per_info mobile_pay_faqs" style="display:;">
					<div class="pay_faqs_container">
						...
						<div class="pay_faqs">
							<h3>How can I reach the Customer Service Team for my issues?</h3>
							<p>You can contact our customer service team at <a href="tel:+91-89776333523">+91-89776333523</a> 
							<!--or you can write us an email at <a href="mailto:info@simandhareducation.com">accounts@simandhareducation.com</a>-->
						</p>
						</div>
						<div class="pay_faqs">
...
//$$api->order->create(array('receipt' => '123', 'amount' => 100, 'currency' => 'INR', 'notes'=> array('key1'=> 'value3','key2'=> 'value2')));
							...
							var options = {
								// "key": "rzp_live_DphxxsOEkX2bF8", // Enter the Key ID rzp_test_lB2doR4eVpMCh6 generated from the Dashboard
								  "key":"rzp_test_6qwUq8prQASUda" // Test Key For dev
								...
								"image": "https://simandhareducation.com/assets/logo-white.png",
