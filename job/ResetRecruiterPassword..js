...
const ResetRecruiterPassword = () => {
  ...
  let { values, errors, touched, handleBlur, handleChange, handleSubmit } =
    ...
    const ResetPassword = async(obj) =>{
      try{
        const response = await axios.patch(`${jobPortalBaseURL}recruiter/password/${query?.token}`, obj,{
          headers : {
...
export default ResetRecruiterPassword;
